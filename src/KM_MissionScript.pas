...
type
  ...
  TKMCommandType = (ct_Unknown=0,ct_SetMap,ct_SetMaxPlayer,ct_SetCurrPlayer,ct_HumanPlayer,ct_UserPlayer,ct_SetHouse,
                    ...
                    ct_AINoBuild,ct_AIAutoRepair,ct_AIAutoAttack,ct_AIAutoDefend,ct_AIDefendAllies,ctAIUnlimitedEquip,ct_AIStartPosition,ct_AIDefence,ct_AIAttack,
                    ct_CopyAIAttack,ct_ClearAIAttack);
...
const
  COMMANDVALUES: array [TKMCommandType] of AnsiString = (
    ...
    'RELEASE_ALL_HOUSES','ADD_GOAL','ADD_LOST_GOAL','SET_UNIT','SET_STREET','SET_FIELD',
    'SET_WINEFIELD','SET_STOCK','ADD_WARE','SET_ALLIANCE','SET_HOUSE_DAMAGE','SET_UNIT_BY_STOCK',
    ...
    'SET_AI_NO_BUILD','SET_AI_AUTO_REPAIR','SET_AI_AUTO_ATTACK','SET_AI_AUTO_DEFEND','SET_AI_DEFEND_ALLIES','SET_AI_UNLIMITED_EQUIP','SET_AI_START_POSITION','SET_AI_DEFENSE','SET_AI_ATTACK',
