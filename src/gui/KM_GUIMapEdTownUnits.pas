...
begin
  ...
  begin
    Button_Citizen[I] := TKMButtonFlat.Create(Panel_Units,(I mod 5)*37,LineY+(I div 5)*37,33,33,gResource.UnitDat[School_Order[I]].GUIIcon); //List of tiles 5x5
    Button_Citizen[I].Hint := gResource.UnitDat[School_Order[I]].GUIName;
  ...
  begin
    ...
    Button_Warriors[I].Hint := gResource.UnitDat[MapEd_Order[I]].GUIName;
  ...
  begin
    ...
    Button_Animals[I].Hint := gResource.UnitDat[Animal_Order[I]].GUIName;
