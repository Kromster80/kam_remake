...
begin
  ...
  begin
    Button_Citizen[I] := TKMButtonFlat.Create(Panel_Units,(I mod 5)*37,LineY+(I div 5)*37,33,33,gRes.UnitDat[School_Order[I]].GUIIcon); //List of tiles 5x5
    Button_Citizen[I].Hint := gRes.UnitDat[School_Order[I]].GUIName;
  ...
  begin
    ...
    Button_Warriors[I].Hint := gRes.UnitDat[MapEd_Order[I]].GUIName;
  ...
  begin
    ...
    Button_Animals[I].Hint := gRes.UnitDat[Animal_Order[I]].GUIName;
