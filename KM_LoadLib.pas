...
type
  ...
  private     { Private declarations }
    ...
    procedure LoadLIBFile(AFile:string; var AArray:array of string);
...
procedure TTextManager.LoadLIBFile(AFile:string; var AArray:array of string);
var
...
begin
  ...
  if not CheckFileExists(AFile) then exit;
  AssignFile(LIBFile, AFile);
  Reset(LIBFile);
