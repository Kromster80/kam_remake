...
var FOW:byte;
  ...
  begin
    ...
    ShiftY := ShiftY + (fRXData[rxTrees].Size[ID].Y) / CELL_SIZE_PX;
...
begin
  ...
  ShiftX := Loc.X +  fRXData[rxGui].Pivot[ID].x/CELL_SIZE_PX + 0.6;
  ShiftY := Loc.Y + (fRXData[rxGui].Pivot[ID].y + fRXData[rxGui].Size[ID].Y)/CELL_SIZE_PX + 0.5 -
