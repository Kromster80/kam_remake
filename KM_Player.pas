...
begin
  ...
  if (fGameG.MissionMode = mm_Normal) and (aTick mod CHARTS_SAMPLING_FOR_ECONOMY = 0)
  or (fGameG.MissionMode = mm_Tactic) and (aTick mod CHARTS_SAMPLING_FOR_TACTICS = 0)
  or (aTick = 1) then
    fStats.UpdateState;
end;
