...
type
  ...
  public
    ...
    InfluenceMinMap: array of array of array of SmallInt;
    ...
    if OVERLAY_NAVMESH then
      ...
      begin
        ...
        begin
          ...
          Sz := Max(fNavMesh.fNodes[I].Owner[K] - 128, 0) / 64;

          fRenderAux.CircleOnTerrain(
            fNavMesh.fNodes[I].Loc.X,
            fNavMesh.fNodes[I].Loc.Y, Sz, Col, Col2);
        end;
      end;
