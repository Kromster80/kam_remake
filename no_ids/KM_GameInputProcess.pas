...
begin
  ...
  case CommandType of
    ...
    gic_BuildRoadPlan:    P.AddRoadPlan(KMPoint(Params[1],Params[2]), mu_RoadPlan,  false, P.PlayerIndex);
    gic_BuildFieldPlan:   P.AddRoadPlan(KMPoint(Params[1],Params[2]), mu_FieldPlan,  false, P.PlayerIndex);
    gic_BuildWinePlan:    P.AddRoadPlan(KMPoint(Params[1],Params[2]), mu_WinePlan,  false, P.PlayerIndex);
    gic_BuildWallPlan:    P.AddRoadPlan(KMPoint(Params[1],Params[2]), mu_WallPlan,  false, P.PlayerIndex);
