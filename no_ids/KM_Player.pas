...
type
  ...
  private
    ...
    fPlayerIndex:shortint; //Which Index this player is in fPlayersCollection
  ...
  public
    ...
    procedure AddRoadPlan(aLoc: TKMPoint; aMarkup:TMarkup; DoSilent:boolean; PlayerReveal:shortint=-1);
...
procedure TKMPlayer.AddRoadPlan(aLoc: TKMPoint; aMarkup:TMarkup; DoSilent:boolean; PlayerReveal:shortint=-1);
begin
  if not fTerrain.CanPlaceRoad(aLoc,aMarkup,PlayerReveal) then
  begin
