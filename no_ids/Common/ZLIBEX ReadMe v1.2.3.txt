...
you can found an optimized version of Zlib 1.2.3 that you can embed into every Delphi executable without use external dlls.
...
Btw: these sources code of zlib 1.2.3 aren't changed by me and now I get some compiler warnings, but don't worry: they are only little hints about code sintax (cross-platform C compiler typical behavior).