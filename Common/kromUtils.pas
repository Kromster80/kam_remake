...
function RunSaveDialog(Sender:TSaveDialog; Name,Path,Filter:string):boolean;
...
nx^:= ((v1[1]-v2[1])*(v1[2]-v3[2])-(v1[2]-v2[2])*(v1[1]-v3[1]))/1024;
ny^:=-((v1[0]-v2[0])*(v1[2]-v3[2])-(v1[2]-v2[2])*(v1[0]-v3[0]))/1024;
nz^:= ((v1[0]-v2[0])*(v1[1]-v3[1])-(v1[1]-v2[1])*(v1[0]-v3[0]))/1024;
end;
...
//Result:=Result and FileExists(Sender.FileName); //Already enabled in OpenDialog options
end;
