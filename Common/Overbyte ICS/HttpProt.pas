...
Dec 10, 2006 V1.94 Jack <jlist9@gmail.com> fixed BandwidthTimerTimer to clear 
             the count.
...
const
    HttpCliVersion       = 194;
    CopyRight : String   = ' THttpCli (c) 1997-2007 F. Piette V1.94 ';
    DefaultProxyPort     = '80';
{$IFDEF DELPHI1}
...
begin
    ...
    if (FHeaderLineCount =  1)   and
       (FLastResponse    <> '')  and
       (FLastResponse[1] =  '<') and
       ((UpperCase(Copy(FLastResponse, 1, 6)) = '<HTML>') or
        (UpperCase(Copy(FLastResponse, 1, 9)) = '<!DOCTYPE')) then begin
