...
begin
  //Half of the maximum round trip is a good guess for delay. +120 is our safety net to account
  //for processing the packet and random variations in ping. It's better for commands to be slightly
  //delayed than for the game to freeze/lag regularly.
  SetDelay( Ceil((fNetworking.NetPlayers.GetMaxHighestRoundTripLatency+120)/200) );
end;
